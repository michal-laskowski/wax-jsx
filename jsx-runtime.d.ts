export declare function jsx(type: string | Function, props: Record<string, any>, key?: string): any

export declare function jsxs(type: string | Function, props: Record<string, any>, key?: string): any
...
export type Child = string | Promise<string> | number | null | undefined | boolean | Child[]

import * as EventsTags from './jsx.events'
import { HtmxAttributes } from './jsx.htmx'
export * from './jsx.htmx'
export namespace JSX {
    ...
    export interface HTMLAttributes extends JSXAttributes, EventAttributes, EventsTags.JSX.HtmlTag, AnyAttributes {
    ...
    export interface IntrinsicElements {
        ...
        body: HTMLAttributes & EventsTags.JSX.HtmlBodyTag
        br: HTMLAttributes
        ...
        fieldset: FieldsetHTMLAttributes & EventsTags.JSX.HtmlFieldSetTag
        figcaption: HTMLAttributes
        figure: HTMLAttributes
        footer: HTMLAttributes
        form: FormHTMLAttributes & EventsTags.JSX.FormEvents
        h1: HTMLAttributes
        h2: HTMLAttributes
        h3: HTMLAttributes
        h4: HTMLAttributes
        ...
        input: InputHTMLAttributes & EventsTags.JSX.HtmlInputTag
    ...
    export interface HTMLAttributes extends HtmxAttributes {}
}
